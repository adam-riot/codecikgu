        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="glass-dark rounded-xl p-6 text-center neon-glow">
              <h3 className="text-3xl font-bold text-electric-blue mb-2">1,250+</h3>
              <p className="text-gray-400">Murid Aktif</p>
            </div>
            <div className="glass-dark rounded-xl p-6 text-center neon-glow">
              <h3 className="text-3xl font-bold text-neon-green mb-2">85+</h3>
              <p className="text-gray-400">Sekolah</p>
            </div>
            <div className="glass-dark rounded-xl p-6 text-center neon-glow">
              <h3 className="text-3xl font-bold text-neon-cyan mb-2">24</h3>
              <p className="text-gray-400">Topik</p>
            </div>
            <div className="glass-dark rounded-xl p-6 text-center neon-glow">
              <h3 className="text-3xl font-bold text-yellow-400 mb-2">15+</h3>
              <p className="text-gray-400">Ganjaran</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-dark rounded-xl p-6 card-hover neon-glow">
              ...
              <h3 className="text-xl font-semibold mb-3">Cabaran Menarik</h3>
              <p className="text-gray-400">Selesaikan cabaran pengaturcaraan yang menarik dan dapatkan XP untuk naik level!</p>
            </div>
            ...
            <div className="glass-dark rounded-xl p-6 card-hover neon-glow">
              ...
              <p className="text-gray-400">Akses nota pembelajaran yang lengkap untuk Tingkatan 4 & 5 mengikut sukatan pelajaran.</p>
            </div>
            ...
            <div className="glass-dark rounded-xl p-6 card-hover neon-glow">
              ...
              <h3 className="text-xl font-semibold mb-3">Sistem Ganjaran</h3>
            ...
            <div className="glass-dark rounded-xl p-6 card-hover neon-glow">
              ...
              <h3 className="text-xl font-semibold mb-3">Komuniti Aktif</h3>
              <p className="text-gray-400">Bergabung dengan komuniti pelajar dan guru yang saling membantu dalam pembelajaran.</p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="glass-dark rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Sertai ribuan pelajar yang telah meningkatkan kemahiran pengaturcaraan mereka dengan CodeCikgu. 
